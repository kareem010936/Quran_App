        ...
        child: ClipRRect(
          ...
          child: BottomNavigationBar(
            ...
            items: const [
              ...
              BottomNavigationBarItem(
                icon: FaIcon(FontAwesomeIcons.handsPraying, size: 24),
                label: "الأدعية",
              ),
              BottomNavigationBarItem(
                icon: FaIcon(FontAwesomeIcons.moon, size: 24),
                label: "الأذكار",
              ),
              BottomNavigationBarItem(
                icon: FaIcon(FontAwesomeIcons.personPraying, size: 24),
                label: "التسبيح",
              ),
              BottomNavigationBarItem(
                icon: FaIcon(FontAwesomeIcons.bookQuran, size: 24),
                label: "القرآن",
              ),
              BottomNavigationBarItem(
